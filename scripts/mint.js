...
async function main() {
  ...
  const contractAddress = "0xB9c9918dd0C46bc31CEFC3768d4BA7b0521Cb1AA";

  // Get the contract factory for the Robotics contract and attach it to the signer
  const OneNFT = await ethers.getContractFactory("Robotics", signer);
