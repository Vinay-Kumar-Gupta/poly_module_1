...
// Asynchronous main function to deploy the Robotics contract
async function main() {
  // Get the contract factory (ABI and bytecode) using the contract name "Robotics"
  const NFT = await hre.ethers.getContractFactory("Robotics");
